 ...
 */
public class ClientBluetooth extends Activity {
    ...
    public void fazerConexoesDoLayout_e_Listeners() {
        ...
        receberDados = (Button) findViewById(R.id.bt_sintetizar);

        textoRecebido = (EditText) findViewById(R.id.editText);
        ...
        public void onClick(View v) {
            ...
            if (bluetoothSocket != null) {
                ...
                try {
                    ...
                    Log.e("MENSAGEM NÃO RECEBIDA", "Ocorreu um erro ao receber a mensagem, o erro foi" + e.getMessage());
